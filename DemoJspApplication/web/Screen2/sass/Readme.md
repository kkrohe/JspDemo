...
folder are mapped to the application's root namespace, 'Screen2'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Screen2' in the same way
as `"Screen2/sass/src"`.
